...
class __TwigTemplate_f11736c466ec7f1a78ce720abcf5303e extends Template
{
    ...
    <form action=\"login\" class=\"w-1/3 grid\" method=\"POST\">
        ...
        // line 19
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["errors"] ?? null), "email", [], "any", false, false, false, 19), "html", null, true);
        yield "</span>
        </div>
        <div class=\"p-4\">
...
{% endblock %}
", "login.html", "C:\\xampp\\htdocs\\templates\\login.html");
    }
}
