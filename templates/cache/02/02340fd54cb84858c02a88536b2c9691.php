...
class __TwigTemplate_7fdac41f4768535bd3deece22942116c extends Template
{
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->loadTemplate("layout.html", "admin/category.html", 1);
    ...
    <form class=\"w-full grid\" action=\"";
        ...
        <div class=\"p-4\">
            ...
            block w-full p-2.5' type=\"text\" id=\"description\" name=\"description\">";
        // line 19
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["category"] ?? null), "description", [], "any", false, false, false, 19), "html", null, true);
        yield "
            </textarea>
            <span class=\"text-red-500\">";
        // line 21
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["errors"] ?? null), "description", [], "any", false, false, false, 21), "html", null, true);
        yield "</span>
        </div>
        <div class=\"p-4\">
            <input class=\"w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600
            \" type=\"checkbox\" id=\"navigation\" name=\"navigation\" ";
        // line 25
        ((CoreExtension::getAttribute($this->env, $this->source, ($context["category"] ?? null), "navigation", [], "any", false, false, false, 25)) ? (yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(($context["checked"] ?? null), "html", null, true)) : (yield ""));
        yield ">
...
";
    ...
    {
        return array (  120 => 25,  113 => 21,  108 => 19,  100 => 14,  96 => 13,  92 => 11,  86 => 9,  84 => 8,  80 => 7,  74 => 6,  71 => 5,  67 => 4,  58 => 3,  49 => 2,  38 => 1,);
    }
...
<main class=\"container w-auto mx-auto md:w-1/2 flex justify-center flex-col items-center p-5\">
    <form class=\"w-full grid\" action=\"{{doc_root}}category.php?id={{id}}\" method=\"POST\">
        ...
        <div class=\"p-4\">
            <label class=\"block mb-2 text-sm font-medium text-gray-900\" for=\"description\">Description</label>
            <textarea class='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 
            block w-full p-2.5' type=\"text\" id=\"description\" name=\"description\">{{category.description}}
            </textarea>
