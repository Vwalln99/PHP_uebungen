...
<body>
    <header class=\"bg-white border-gray-200 dark:bg-gray-900 border-b-4\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["link"]) {
            ...
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(($context["doc_root"] ?? null), "html", null, true);
            yield "admin/";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["link"], "url", [], "any", false, false, false, 36), "html", null, true);
            yield "\">
                                ";
            // line 37
